...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionToHtml = new QAction(MainWindow);
        ...
        menuFile->addAction(actionExit_All);
...
#endif // QT_CONFIG(shortcut)
        actionToHtml->setText(QCoreApplication::translate("MainWindow", "ToHtml", nullptr));
#if QT_CONFIG(shortcut)
...
#endif // QT_CONFIG(shortcut)
        actionExit_All->setText(QCoreApplication::translate("MainWindow", "Exit All", nullptr));
#if QT_CONFIG(shortcut)
...
#if QT_CONFIG(shortcut)
        actionUpdate->setShortcut(QCoreApplication::translate("MainWindow", "Ctrl+U", nullptr));
#endif // QT_CONFIG(shortcut)
